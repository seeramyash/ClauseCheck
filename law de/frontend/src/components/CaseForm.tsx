        ...
        <div className="rounded-3xl p-10 animate-scale-in" style={{
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            <div className="space-y-3">
              <label className="block text-sm font-bold uppercase tracking-wider flex items-center gap-3 text-white/90">
            ...
            {/* Case Facts */}
            <div className="space-y-3">
              <label className="block text-sm font-bold uppercase tracking-wider flex items-center gap-3 dark:text-white/90 light:text-gray-800">
